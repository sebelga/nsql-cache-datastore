...
module.exports = ds => {
    /**
     * Since v2.0.0 of @google/datastore the isInt() helper
     * is on the "googleDatastore" prop of the datastore instance
     */
    const isInt = ds ? ds.isInt || ds.googleDatastore.isInt : () => {};
